    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <button
          ...
          className="inline-flex items-center px-4 py-2 bg-[#0f1729] hover:bg-[#212121]
      ...
      <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0f1729]"
          />
        ...
        <select
          ...
          className="border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#0f1729]"
        >
