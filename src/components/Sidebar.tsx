  ...
  return (
    <>
      <button
        ...
        className="fixed md:hidden top-4 right-4 z-50 p-2 rounded-lg bg-[#171717] text-white hover:bg-[#212121] focus:outline-none focus:ring-2 focus:ring-[#212121]"
      ...
      <aside
        className={`
          ...
          w-64 bg-[#171717] text-white h-screen
