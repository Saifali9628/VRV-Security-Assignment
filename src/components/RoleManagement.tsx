    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="inline-flex items-center px-4 py-2 bg-[#0f1729] hover:bg-[#212121] text-white rounded-lg transition-colors duration-200 ease-in-out shadow-sm hover:shadow-md w-full sm:w-auto justify-center"
        >
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="p-2 text-green-600 hover:bg-blue-50 rounded-full transition-colors duration-200"
                    title="Edit role"
                  >
              ...
              <div className="flex flex-wrap gap-2">
                {role.permissions.length > 0 ? (
                  role.permissions.map((permission) => (
                    <span
                      key={permission}
                      className="px-3 py-1 bg-[#dcfce7] text-[#1a6938] rounded-full text-sm font-medium capitalize transition-colors duration-150 hover:bg-blue-100"
                    >
                      {permission}
                    </span>
                  ))
